...
void mouth3() {
  allLedsOff();
  strip.setPixelColor(3, strip.Color(0, 0, 255));         //  Set pixel's color (in RAM)
  strip.setPixelColor(4, strip.Color(0, 0, 255));         //  Set pixel's color (in RAM)
  strip.show();
  delay(50);
  
  strip.setPixelColor(2, strip.Color(0, 0, 255));         //  Set pixel's color (in RAM)
  ...
  strip.setPixelColor(6, strip.Color(0, 0, 255));         //  Set pixel's color (in RAM)
  strip.show();
  delay(50);
  
  strip.setPixelColor(0, strip.Color(0, 0, 255));         //  Set pixel's color (in RAM)
  strip.setPixelColor(7, strip.Color(0, 0, 255));         //  Set pixel's color (in RAM)
  strip.show();
  delay(50);
  strip.setPixelColor(0, strip.Color(0, 0, 0));         //  Set pixel's color (in RAM)
  strip.setPixelColor(7, strip.Color(0, 0, 0));         //  Set pixel's color (in RAM)
